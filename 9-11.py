...
# Set the Game Images
pipe_img = pygame.transform.scale2x(pygame.image.load(os.path.join("img","tower.jpeg")).convert_alpha())
bg_img = pygame.transform.scale(pygame.image.load(os.path.join("img","background-day.png")).convert_alpha(), (600, 900))
bird_images = [pygame.transform.scale(pygame.image.load(os.path.join("img","bird" + str(x) + ".png")), (75, 75)) for x in range(1,4)]
